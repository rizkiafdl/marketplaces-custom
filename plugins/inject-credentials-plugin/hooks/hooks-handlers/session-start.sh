...
if [ -n "$CONFIG_FILE" ] && [ -f "$CONFIG_FILE" ]; then
    ...
    if [ ! -z "$NOTION_DATA_SOURCE_ID" ]; then
        ...
        export NOTION_TITLE_PROPERTY="${NOTION_TITLE_PROPERTY:-title}"
        export NOTION_CATEGORY_OPTIONS="${NOTION_CATEGORY_OPTIONS:-}"
